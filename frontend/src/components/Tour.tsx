...
export const TOUR: Step[] = [
  ...
  { tab: "journeys", phase: "Activate", title: "Journeys",
    say: "Seamless cross-channel made real: an ordered cadence that sends on one channel, and if the customer engages it stops — goal met. If not, it escalates to the next channel, following them wherever they are. Every touch lands in the Customer-360 timeline.",
    tip: "Start a journey, then ‘Simulate response’ to watch it branch and convert." },
