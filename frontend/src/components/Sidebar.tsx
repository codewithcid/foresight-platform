...
export type Tab = "dashboard" | "workflows" | "store" | "journeys" | "planner" | "byocsv" | "creative" | "channels" | "proof" | "agentops" | "settings";
...
const NAV: { group: string; items: { key: Tab; label: string; icon: ReactNode }[] }[] = [
  {
    ...
    items: [
      ...
      { key: "store", label: "Link-Up", icon: <i className="ri-plug-line text-[18px]" /> },
      { key: "journeys", label: "Journeys", icon: <i className="ri-route-line text-[18px]" /> },
